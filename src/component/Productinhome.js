...
//json-server --watch laptopjson.json --port 4000
...
class Productinhome extends Component {
    state={
        ...
        indexvalue: 0,
        cartvalue: 1,
        ArrStorage:localStorage.getItem('CartStorage') ? JSON.parse(localStorage.getItem('CartStorage')) : []
    }
    componentDidMount(){
                                    ...
                                    <div key={index}>
                                        <Row>
                                            ...
                                            <Col lg={6} className="Modal-col2">
                                                    ...
                                                    <h6 className="Modal-col2-price">{prod.price}</h6>
                                                <Row>
                                                    <Col>
                            ...
                            if(index < 12){
                                ...
                                <Col lg={3} key={index}>
                                    ...
                                    <div className="desc-productinhome">
                                        ...
                                        <h6 className="desc-productinhome-price">{product.price}</h6>
                                    </div>
                                </Col>
                                )
                            }
